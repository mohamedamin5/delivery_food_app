          ...
          child: CustomScrollView(
            slivers: [
              SliverToBoxAdapter(
                child: Column(
                  children: [
                    _buildHeader(appLocalizations.translate('home_deliver_to')),
                    SizedBox(height: 20.h),
                    _buildSearchBar(appLocalizations.translate('search_hint')),
                    SizedBox(height: 20.h),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Text(
                          appLocalizations.translate("home_all_categories"),
                          style: TextStyle(fontSize: 20.sp),
                        ),
                        Row(
                          children: [
                            Text(appLocalizations.translate("home_see_all")),
                            const Icon(
                    ...
                    Row(
                      ...
                      children: [
                        Text(
                          appLocalizations.translate("home_open_restaurants"),
                          style: TextStyle(fontSize: 20.sp),
                        ),
                        GestureDetector(
                          onTap: () {},
                    ...
                    child: Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          SizedBox(height: 10.h),
                          Text(
                            restaurantlist[index].categorie.keys.join(' - '),
                            maxLines: 1,
                            overflow: TextOverflow.ellipsis,
                          ),
                          Row(
                            ...
                            children: [
                              Row(
                                children: [
                                  ...
                                  Text(restaurantlist[index].delivery),
                                ],
                              ),
                              Row(
                                children: [
                                  ...
                                  Text(restaurantlist[index].rating.toString()),
                                ],
                              ),
                              Row(
                                children: [
                                  ...
                                  Text(restaurantlist[index].time),
                                ],
                              ),
                            ],
                          ),
